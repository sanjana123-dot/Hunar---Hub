          ...
          <div className="about-content">
            <div className="about-text">
              ...
              <p>
                ...
                to expand your reach, HunarHub provides a trusted platform that connects talent with opportunity.
              </p>
            </div>
        ...
        <div className="container">
          ...
          <div className="features-grid">
            ...
            <div className="feature-card featured">
              ...
              <Link to="/register" className="feature-link">Join Now →</Link>
            </div>
            ...
            <div className="feature-card">
              ...
              <Link to="/entrepreneurs" className="feature-link">Explore →</Link>
            </div>
          </div>
        </div>
      </section>
